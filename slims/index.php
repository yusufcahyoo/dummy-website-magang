...
$opacVariable = [
    ...
    // default header info
    'header_info' => (utility::isMemberLogin() ? '<div class="alert alert-info alert-member-login" id="memberLoginInfo">'.__('You are currently Logged on as member').': <strong>'.$_SESSION['m_name'].' (<em>'.$_SESSION['m_email'].'</em>)</strong> <a id="memberLogout" href="http://127.0.0.1:8000/home">'.__('LOGOUT').'</a></div>' : ''),
