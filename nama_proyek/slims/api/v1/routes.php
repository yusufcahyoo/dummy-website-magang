...
$router->map('GET', '/biblio/all', 'BiblioController@getAll');  // This is the route you're using
...
$router->map(
    'GET',
    '/biblio/coll_type/[*:coll_type]',
    'BiblioController@getByCollType'
);
...
$router->map(
    ...
    'ItemController@getTotalAvailable'
);
...
// Plugin hooks
\SLiMS\Plugins::getInstance()->execute('custom_api_route', [
    'router' => $router,
]);
